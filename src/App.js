  ...
  return (
    <div className="navbar">
      ...
      <div
        ...
        id="hamburger"
        className={
          dropdown ? "hamburger-container active" : "hamburger-container"
        }
      >
        <div></div>
      </div>
    ...
    <main>
      <div id="home" className="content-container">
        ...
        <section className="section-1">
          ...
          <div className="section-1__title-container">
        ...
        <section id="new" className="section-2">
          <div>
            ...
            <p>
              Lorem ipsum dolor sit amet consectetur, adipisicing elit.
              Explicabo officiis non recusandae voluptates corporis!
            </p>
          </div>
